...
main_content: >
  ...
  <h1 class="signature nothing-you-could-do text-5xl md:text-6xl leading-tight mb-1">
      Allison Wedler
    </h1>
  <p class="hero-subtitle animation-fade" style="animation-delay: 2.5s;">
    Designer. Thinker. Educator.
  </p>
...
Here is some more homepage stuff. 
